...
public class C04EExercice8 {
	public static void main(String[] args) {
		...
		double result = Math.pow(1.0/(ecartType * Math.sqrt(2.0 * Math.PI)) , -1.0/2.0 * Math.pow((valeur - moyenne) / ecartType, 2.0));
		
		double result2  = (1.0 / (ecartType * Math.sqrt(2 * Math.PI))) * Math.exp(-(1.0/2.0) * Math.pow((valeur - moyenne)/ecartType, 2));
